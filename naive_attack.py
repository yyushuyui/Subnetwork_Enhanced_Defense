...
csv_file_path = "/cl/work10/shuyi-yu/LogitsEditingBasedDefense/datasets/harmful_behaviors.csv"
print(f"Loading dataset from {csv_file_path}...")
harmful_data = pd.read_csv(csv_file_path)
prompts = harmful_data["goal"].tolist()
...
formatted_prompts = [prefix.replace("\n", "") + q + "." + suffix for q in prompts]
...
output_path = "/cl/work10/shuyi-yu/LogitsEditingBasedDefense/results/naive_attack_responses8.csv"
